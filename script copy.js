...
const initialMovie = document.getElementById("movie01");
initialMovie.remove();
...
btnLeft.addEventListener("click", (e) => {
  let movieWidth = document.querySelector(".movie1").getBoundingClientRect()
    .width;
